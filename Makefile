...
compiler_rcc_clean:
compiler_moc_header_make_all: moc_Smtp.cpp moc_MainUI.cpp moc_SendMail.cpp moc_Connexion.cpp moc_BestSocketEver.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_Smtp.cpp moc_MainUI.cpp moc_SendMail.cpp moc_Connexion.cpp moc_BestSocketEver.cpp
