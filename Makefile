...
SOURCES       = srcs/Smtp.cpp \
		...
		srcs/pop3.cpp \
		srcs/BestSocketEver.cpp moc_Smtp.cpp \
		moc_MainUI.cpp \
		moc_SendMail.cpp \
		moc_Connexion.cpp \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/mailify1.0.0/ && $(COPY_FILE) --parents header/Smtp.hpp header/MainUI.hpp header/SendMail.hpp header/Connexion.hpp header/GetCredentials.hpp header/AMail.hpp header/AMailRetrieve.hpp header/BestSocketEver.hpp .tmp/mailify1.0.0/ && $(COPY_FILE) --parents srcs/Smtp.cpp srcs/main.cpp srcs/MainUI.cpp srcs/SendMail.cpp srcs/Connexion.cpp srcs/GetCredentials.cpp srcs/pop3.cpp srcs/BestSocketEver.cpp .tmp/mailify1.0.0/ && (cd `dirname .tmp/mailify1.0.0` && $(TAR) mailify1.0.0.tar mailify1.0.0 && $(COMPRESS) mailify1.0.0.tar) && $(MOVE) `dirname .tmp/mailify1.0.0`/mailify1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/mailify1.0.0
