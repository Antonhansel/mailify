...
SOURCES       = srcs/Console.cpp \
		srcs/main.cpp \
		srcs/MainUI.cpp moc_Console.cpp \
		moc_MainUI.cpp
OBJECTS       = Console.o \
		main.o \
		MainUI.o \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/mailify1.0.0/ && $(COPY_FILE) --parents header/Console.hpp header/MainUI.hpp .tmp/mailify1.0.0/ && $(COPY_FILE) --parents srcs/Console.cpp srcs/main.cpp srcs/MainUI.cpp .tmp/mailify1.0.0/ && (cd `dirname .tmp/mailify1.0.0` && $(TAR) mailify1.0.0.tar mailify1.0.0 && $(COMPRESS) mailify1.0.0.tar) && $(MOVE) `dirname .tmp/mailify1.0.0`/mailify1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/mailify1.0.0
...
compiler_rcc_clean:
compiler_moc_header_make_all: moc_Console.cpp moc_MainUI.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_Console.cpp moc_MainUI.cpp
