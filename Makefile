...
SOURCES       = srcs/Console.cpp \
		srcs/main.cpp \
		srcs/MainUI.cpp \
		srcs/SendMail.cpp moc_Console.cpp \
		moc_MainUI.cpp \
		moc_SendMail.cpp
OBJECTS       = Console.o \
		main.o \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/mailify1.0.0/ && $(COPY_FILE) --parents header/Console.hpp header/MainUI.hpp header/SendMail.hpp .tmp/mailify1.0.0/ && $(COPY_FILE) --parents srcs/Console.cpp srcs/main.cpp srcs/MainUI.cpp srcs/SendMail.cpp .tmp/mailify1.0.0/ && (cd `dirname .tmp/mailify1.0.0` && $(TAR) mailify1.0.0.tar mailify1.0.0 && $(COMPRESS) mailify1.0.0.tar) && $(MOVE) `dirname .tmp/mailify1.0.0`/mailify1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/mailify1.0.0
...
compiler_rcc_clean:
compiler_moc_header_make_all: moc_Console.cpp moc_MainUI.cpp moc_SendMail.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_Console.cpp moc_MainUI.cpp moc_SendMail.cpp
moc_Console.cpp: /usr/include/qt5/QtWidgets/QWidget \
...
moc_SendMail.cpp: header/Console.hpp \
		/usr/include/qt5/QtWidgets/QWidget \
		/usr/include/qt5/QtWidgets/qwidget.h \
		/usr/include/qt5/QtGui/qwindowdefs.h \
		/usr/include/qt5/QtCore/qglobal.h \
...
Console.o: srcs/Console.cpp header/Console.hpp \
		/usr/include/qt5/QtWidgets/QWidget \
		/usr/include/qt5/QtWidgets/qwidget.h \
		/usr/include/qt5/QtGui/qwindowdefs.h \
		/usr/include/qt5/QtCore/qglobal.h \
		...
		/usr/include/qt5/QtWidgets/QLineEdit \
		/usr/include/qt5/QtWidgets/qlineedit.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Console.o srcs/Console.cpp
